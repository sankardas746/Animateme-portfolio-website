...
import { Settings, Edit3, MessageSquare, Briefcase, FileText, User, Users, Film, PenSquare, Quote, BarChart, Home, Mail, DollarSign, Shield, FolderKanban, Info } from 'lucide-react';
...
import HomeAboutManager from './HomeAboutManager';
...
const AdminDashboard = () => {
    ...
    const tabs = [
        ...
        { id: 'home_about', label: 'Home About Section', icon: Info },
